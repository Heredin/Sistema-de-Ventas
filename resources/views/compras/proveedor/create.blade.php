...
<!--Plantilla que  contiene los formularios y botones para crear un proveedor -->
...
@section ('contenido')
      <div class="row">
            ...
            <div class="row">
                  ...
                  <input type="text" name="nombre" required value="{{old('nombre')}}" class="form-control" placeholder="Nombre de Empresa...">
            </div>
            </div>
            <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                        <div class="form-group">
            ...
            <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                  ...
                  <input type="text" name="telefono"  value="{{old('telefono')}}" class="form-control" placeholder="Número de Télefono...">
            </div>
                  </div>
                     <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                  <div class="form-group">
